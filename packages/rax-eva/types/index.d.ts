...
type GameObjectChildren = gameobject | RaxText | JSX.Element;
...
export interface EVAComponentProps extends TransformParams, TextStyleParams, RenderParams, EventParams, EVA.ListeningProps {
  name?: string;
  components?: Component[];
  children?: gameobject | gameobject[] | RaxText | RaxText[] | JSX.Element | JSX.Element[];
  [name: string]: any;
}
