import {createElement, render, useCallback, useState, useEffect, memo, Fragment} from 'rax';
...
const Intro = memo(() => {
  ...
  const logoComponents = useComponents(
    logoImgComponent,
  );
  ...
  const startComponents = useComponents(
    startImgComponent,
  );
...
function App() {
  ...
  const preloadComplete = useCallback(() => setShowLoading(false), []);
